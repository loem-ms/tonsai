...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Continual pretraining for Gemma 3 1B")
    parser.add_argument("--model", type=str, default="google/gemma-3-1b-it", help="Base Gemma model id or local path")
    parser.add_argument("--dataset-dir", type=Path, required=True)
    parser.add_argument("--dataset-split", type=str, default="train")
    parser.add_argument("--text-column", type=str, default="text")
    parser.add_argument("--output-dir", type=Path, default=Path("artifacts/gemma3-cpt"))
